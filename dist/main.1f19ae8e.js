...
var div1 = dom.create("<div>把这段话插到after-test后面</div>");
var table = dom.create("<table><tr><td>12</td></tr></table>");
var td = dom.create("<td>1111</td>");
var div2 = dom.create("<div>把这段话插到before-test前面</div>");
var div3 = dom.create("<div id='firstChild'>222</div>");
var div4 = dom.create("<div id='parent' style='color:blue'>我是dom插入的父亲，我的儿子是parentTest</div>"); // console.log(div)
// console.log(table)
...
var title = dom.attr(modifyTest, 'title'); // 读取属性值

console.log("modifyTest:".concat(title));
...
var t1 = dom.find('#travel')[0];
dom.each(dom.children(t1), function (n) {
  return dom.style(n, 'color', 'red');
});
console.log(dom.index(s2));
var div = dom.find('#test>.red')[0]; // console.log(div)
